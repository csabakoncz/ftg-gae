...
privileged aspect StylesheetController_Roo_Controller {
    ...
    public String StylesheetController.show(@PathVariable("id") String id, Model uiModel) {
    ...
    public String StylesheetController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("stylesheets", Stylesheet.findStylesheetEntries(firstResult, sizeNo));
    ...
    public String StylesheetController.updateForm(@PathVariable("id") String id, Model uiModel) {
        populateEditForm(uiModel, Stylesheet.findStylesheet(id));
        return "stylesheets/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String StylesheetController.delete(@PathVariable("id") String id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
